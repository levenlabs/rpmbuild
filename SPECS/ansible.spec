%define name ansible
%define ansible_version 2.0.0
%define ansible_version_suffix -0.2.alpha2
...
Source: http://releases.ansible.com/ansible/%{name}-%{version}%{ansible_version_suffix}.tar.gz
